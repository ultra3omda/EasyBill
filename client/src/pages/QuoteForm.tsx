...
function QuoteFormContent() {
  ...
  const { data: quote, isLoading: quoteLoading } = trpc.quote.get.useQuery(
  ...
  const updateMutation = (trpc.quote as any).update.useMutation({
    onSuccess: () => {
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            {isEdit ? "Modifiez les détails du devis" : "Créez un nouveau devis client"}
          </p>
        </div>
      </div>
